...
export default class Controls extends EventEmitter
{
    ...
    setKeyboard()
    {
        ...
        {
            if(document.querySelector('dialog[open]') || _event.target.closest?.('button, input, select, a')) return
    ...
    setTouch()
    {
        ...
        this.touch.joystick.$element.classList.add('touch-control')
        ...
        this.touch.boost.$element.classList.add('touch-control')
        ...
        this.touch.forward.$element.classList.add('touch-control')
        ...
        this.touch.brake.$element.classList.add('touch-control')
        ...
        this.touch.backward.$element.classList.add('touch-control')
