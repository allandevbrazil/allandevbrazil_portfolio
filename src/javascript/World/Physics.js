...
export default class Physics
{
    constructor(_options)
    {
        ...
        this.time.on('tick', () =>
        {
            // Small fixed substeps keep fast cars from crossing thin obstacles
            // during a long rendered frame (up to the clock's 60 ms cap).
            this.world.step(1 / 120, this.time.delta / 1000, 8)
        })
    }
    ...
    setCar()
    {
        ...
        this.time.on('tick', () =>
        {
            ...
            // Update wheels
            this.car.vehicle.setSteeringValue(- this.car.steering * (this.car.steerSign || 1), this.car.wheels.indexes.frontLeft)
            this.car.vehicle.setSteeringValue(- this.car.steering * (this.car.steerSign || 1), this.car.wheels.indexes.frontRight)
