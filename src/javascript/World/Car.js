...
export default class Car
{
    ...
    setAntena()
    {
        ...
        this.antena.object.position.set(-1.06, 0.55, -0.18) // reposiciona no teto do Gol (posição original era do jipe)
    ...
    setWheels()
    {
        ...
        for(let i = 0; i < 4; i++)
        {
            ...
            object.visible = false // o Gol já traz as próprias rodas embutidas no chassis
