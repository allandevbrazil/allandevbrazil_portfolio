...
export default class Materials
{
    ...
    setShades()
    {
        ...
        this.shades = {}
        this.shades.items = {}
        this.shades.indirectColor = '#12b6d8'
        ...
        // Neon pink (pintura do Gol)
        this.shades.items.neonPink = new MatcapMaterial()
        this.shades.items.neonPink.name = 'shadeNeonPink'
        this.shades.items.neonPink.uniforms.matcap.value = this.resources.items.matcapNeonPinkTexture
        this.items.neonPink = this.shades.items.neonPink
    ...
    setFloorShadow()
    {
        ...
        this.items.floorShadow.shadowColor = '#ff2e88'
