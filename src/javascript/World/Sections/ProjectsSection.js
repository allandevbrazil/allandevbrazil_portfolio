...
export default class ProjectsSection
{
    ...
    setList()
    {
        this.list = profile.projects.map(project => ({
            name: project.name,
            imageSources: project.cover ? [project.cover] : [projectImage(project)],
