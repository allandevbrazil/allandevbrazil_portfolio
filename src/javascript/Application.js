import addParticles from './portfolio/particles.js'
...
export default class Application
{
    ...
    setRenderer()
    {
        ...
        this.renderer.setPixelRatio(Math.min(window.devicePixelRatio || 1, matchMedia('(pointer: coarse)').matches ? 1.25 : 1.75))
    ...
    setPasses()
    {
        ...
        this.passes.horizontalBlurPass.strength = this.config.touch ? 0 : 0.45
        ...
        this.passes.verticalBlurPass.strength = this.config.touch ? 0 : 0.45
        ...
        this.passes.glowsPass.color = '#ff6ec7'
